<template>
  ...
  <header class="bg-white">
    <div class="container mx-auto px-2 py-4 flex items-center">
      <!-- logo -->
      ...
      <!-- <ul class="mt-4 space-y-2 text-lg font-medium">
        <li>
          <NuxtLink to="/" class="block py-2 px-4 hover:text-gray-700"
            >Home</NuxtLink
          >
        </li>
        <li>
          <NuxtLink to="/contact" class="block py-2 px-4 hover:text-gray-700"
            >Contact</NuxtLink
          >
        </li>
        <li>
          <NuxtLink to="/about" class="block py-2 px-4 hover:text-gray-700"
            >About</NuxtLink
          >
        </li>
        <li>
          <NuxtLink to="/auth" class="block py-2 px-4 hover:text-gray-700"
            >Sign Up</NuxtLink
          >
        </li>
      </ul> -->
      ...
      <nav class="contents">
        <ul class="ml-4 xl:w-48 flex items-center justify-end">
          <li class="ml-2 lg:ml-4 relative inline-block cursor-pointer">
            <NuxtLink
              :to="'/profile'"
              class="block py-2 px-4 hover:text-gray-700"
            >
              <svg
          ...
          <li class="ml-2 lg:ml-4 relative inline-block cursor-pointer">
            <NuxtLink @click="goToWishList">
              <div
                class="absolute -top-1 right-0 z-10 bg-primary text-white text-xs font-bold px-1 py-0.5 rounded-sm"
              >
                {{ wishListCount }}
              </div>
              <svg
