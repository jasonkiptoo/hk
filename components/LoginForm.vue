<template>
  <div class="">
    <!-- <div class="hidden md:flex w-full md:w-1/2 items-center justify- mb-4 md:mb-0 image_cont">
        <img src="@/assets/images/logoo.png" alt="Login" class="h-full" />
      </div> -->
    <div class="flex bg-red-200 w-full h-full flex-col items-center justify-center">
      ...
      <div v-if="!isVerified">
        ...
        <form @submit.prevent="login" class="w-full flex flex-col items-center">
          ...
          <div class="flex flex-col gap-4 w-full bg-red-300">
            <FloatLabel variant="on">
              <InputText type="email" id="email" v-model="value3" />
              <label for="email">Email</label>
            </FloatLabel>

            <FloatLabel variant="on">
              <Password v-model="value" id="password" toggleMask />
