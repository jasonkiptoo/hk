<template>
    <div class="flex gap-6 p-4">
        ...
        <div class="w-1/5 bg-white shadow p-4 rounded-lg">
            <ul class="space-y-4">
                <li class="flex items-center gap-2 pt-3 hover:text-primary cursor-pointer  font-medium"
        ...
        <div class="flex-1 bg-white shadow rounded-lg p- relative">
            <div class="flex items-center gap-6">
                ...
                <div class="relative p-4">
                    <h2 class="text-4xl font-bold">Break from <br /> reality</h2>
                    <p class="text-lg text-gray-600">HD and Audio</p>
                    <div class="bg-primary text-white font-bold px-4 py-2 inline-block mt-4 rounded">
                        As low as KSH 2,300
                    </div>
                </div>
                <Carousel :verticalViewPortHeight="200" :value="images" :numVisible="1" :numScroll="1"
                ...
                <button class="bg-black text-white px-6 py-2 mt-6 rounded-lg absolute bottom-6 right-6">
                    Shop Now
                </button>
