                    ...
                    <StepPanels>
                        ...
                        <StepPanel v-slot="{ activateCallback }" :value="1">
                            <div class="flex flex-col gap-2 mx-auto" style="min-height: 16rem; max-width: 30rem">
                                <div class="text-center mt-4 mb-4 text-xl font-semibold">Section 1: Business
                                    Identification
                                </div>
                                <div class="field">
                                ...
                                <div class="field">
                                    ...
                                    <InputText id="location" v-model="location" type="text"
                                        placeholder="City, State, Country" fluid />
                                </div>
                                <div class="font-bold">
                                    Business Type
                                </div>
                                <div v-for="category in businessCategories" :key="category.key"
                                ...
                                <div v-for="category in yearExperience" :key="category.key"
                                    class="flex items-center gap-2">
                                    <RadioButton v-model="businessType" :inputId="category.key" name="dynamic"
                                        :value="category.name" />
                                    <label :for="category.key">{{ category.name }}</label>
                        ...
                        <StepPanel v-slot="{ activateCallback }" :value="2">
                            <div class="flex flex-col gap-2 mx-auto" style="min-height: 16rem; max-width: 30rem">
                                <div class="text-center mt-4 mb-4 text-xl font-semibold">Section 2: Technical Experience
                                </div>
                                <div>
                        ...
                        <StepPanel v-slot="{ activateCallback }" :value="3">
                            <div class="flex flex-col gap-2 mx-auto" style="min-height: 16rem; max-width: 30rem">
                                <div class="text-center mt-4 mb-4 text-xl font-semibold">Section 3: Technical Questions
                                </div>
                                <div class="field">
                                    <label for="purchaseSource">Where do you currently purchase your security
                                        products?</label>
                                    <InputText id="purchaseSource" v-model="purchaseSource" type="text"
                                        placeholder="Enter details" fluid />
                                </div>
                                <div class="field">
                                    <label>Do you currently purchase Hikvision products?</label>
                                    <div v-for="category in options" :key="category.key"
                                        class="flex items-center gap-2">
                                ...
                                <div class="field">
                                    ...
                                    <div v-for="category in options" :key="category.key"
                                        class="flex items-center gap-2">
                                        <RadioButton v-model="requiresTraining" :inputId="category.key"
                                            name="requiresTraining" :value="category.name" />
                                        <label :for="category.key">{{ category.name }}</label>
                                    </div>
                                </div>
                            </div>
    ...
    data() {
        return {
            ...
            experienceAreasList: [
                ...
                { name: "Networking and Computer Products", key: "Networking and Computer Products" },
