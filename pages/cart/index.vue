    ...
    <div class="cart">
        <table class="responsive-table container mx-auto">
            ...
            <tbody>
                <tr v-for="item in cartItems" :key="item.id">
                    ...
                    <td>KES {{ formattedPrice(item.product?.defaultPrice) }}</td>
                    <td>
                    ...
                    <td>KES {{ formattedPrice(item.product.defaultPrice * item.quantity) }}</td>
                    <td>
        ...
        <div class="flex-container container mx-auto">
            ...
            <div class="cart-total border p-12">
                ...
                <!-- <p>Shipping: Free</p> -->
                <hr />
                <p><strong>Total: KES {{ formattedPrice(cartTotal) }}</strong></p>
...
const removeItem = async (id) => {
    await productStore.removeFromCart(id.productId);
