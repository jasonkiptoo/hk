  ...
  <div class="product-section pt-32">
    <div class="flex justify-center items-start">
      ...
      <div class="product-details w-1/3">
        ...
        <button
          class="px-6 py-3 bg-orange-500 text-white rounded-lg shadow-lg hover:bg-orange-600"
        >
          SHOP NOW →
        </button>
      </div>
      ...
      >
        ...
        />
        <div
          class="absolute bottom-0 left-0 text-white bg-orange-500 text-sm px-3 py-1 rounded-full"
      ...
      features: [
        {
          icon: "pi pi-truck",
          title: "Free Shipping",
          description: "Free shipping over KES 100,000",
        },
        {
          icon: "pi pi-lock",
